...
2. Select Create Project, this will guide you through the options to create a new project. Name it `genesys2_standardmicroblaze`
...
3. This example we do not add design files. We add the constrain file downloaded from [Genesys2 Digilent git page](https://github.com/Digilent/digilent-xdc).
...
4. Then select the Part (FPGA) or the Board (Genesys2). In the [Digilent web page]( https://digilent.com/reference/programmable-logic/genesys-2/start) you can locate the part: XC7K325TFFG900-2.
...
5. Otherwise, you can select the board:

![Selecting the genesys2 board](img/figure_0007.png)

<center><em>Figure 7. Selecting the genesys2 board. Refresh the catalogue updates the boards available.</em></center><br>

Then the project has been created.

![Main window of Vivado IDE](img/figure_0009.png)

<center><em>Figure 8. Main window of Vivado IDE for the new hardware project.</em></center><br>


### Step 2: Create an IP Integrator Design

1. From Flow Navigator, under IP integrator, select Create Block Design. Same menu can be expanded on IP Integrator tab.

![Vivado IP Integrator](img/page_010_img_01.jpeg)

<center><em>Figure 9. Vivado IP Integrator.</em></center><br>
...
<center><em>Figure 10. Creating a Block Design.</em></center><br>


3. In the IP integrator diagram area, right-click and select Add IP. The IP integrator Catalog opens. Alternatively, you can also select the Add IP icon in the middle of the canvas.

![MIG IP](img/page_011_img_01.jpeg)

<center><em>Figure 11. MIG IP.</em></center><br>
...
<center><em>Figure 12. Run Block Automation.</em></center><br>


5. After Block Automation runs the MIG is connected.

![MIG connected](img/page_011_img_03.jpeg)

<center><em>Figure 13. MIG connected.</em></center><br>


6. Then add new IP MicroBlaze:

![MicroBlaze IP](img/page_012_img_01.jpeg)

<center><em>Figure 14. MicroBlaze IP.</em></center><br>


![MicroBlaze IP and MIG](img/page_012_img_02.jpeg)

<center><em>Figure 15.MicroBlaze IP and MIG.</em></center><br>


7. There are several ways to use an existing interface in IP integrator. Use the Board window to instantiate some of the interfaces that are present on the Genesys2 board.

![Using the Board Window](img/page_012_img_03.jpeg)

<center><em>Figure 16. Using the Board Window.</em></center><br>
...
8. Now, drag and drop LEDs into the same GPIO for the switches, this will merge both LEDs and SWs in the same AXI_GPIO.

![Canvas with MB, UART, GPIO...](img/page_013_img_01.jpeg)

<center><em>Figure 17. Canvas with MB, UART, GPIO and Reset for the DDR3 Memory System.</em></center><br>
